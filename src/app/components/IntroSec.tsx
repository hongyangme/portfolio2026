        ...
        <section className="w-full min-h-max">
            <div className="relative flex flex-col justify-center h-full text-primary w-[60%] right-0 mr-[10%] mx-auto py-30">
                ...
                <p className="text-base w-[90%] break-all">안녕하세요! 저는 도전을 좋아하며 지속적인 성장을 추구하고 있습니다.
                    ...
                    평소에 사회 트렌드에 관심이 많아 블로그와 모바일 한경 어플 등을 읽으며 현재 무엇이 이목을 끄는 트렌드이고, 미래에는 어느 산업이 돌풍을 일으킬 것인지를 보는 것에 흥미를 가지고 있습니다.

                    React 환경에서의 작업도 익히기 위해 공부하고 있는 중 입니다.

                    제가 가장 자신 있는 것은 시맨틱하고 유지 보수가 편리한 마크업과 CSS 구성입니다.

                    스크롤과 마우스 트리거를 인터렉티브한 웹 효과를 구현이 가능합니다.

                    Vue 환경에서 컴포넌트화 및 동적인 UI구현이 가능합니다.</p>
            </div>
        </section>
    );
}